...
class DQNNet(nn.Module):
    def __init__(self, h, w, outputs):
        ...
        self.hidden_size1 = 4
        self.linear1 = nn.Linear(linear_input_size, self.hidden_size1, bias=False)
        ...
        # 融合处理
        self.linear3 = nn.Linear(self.hidden_size1 + outputs, outputs)
    ...
    def forward(self, x, max_pos):
        ...
        max_pos = F.relu((self.linearLow3(max_pos)))
